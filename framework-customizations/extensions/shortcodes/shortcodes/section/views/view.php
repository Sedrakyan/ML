...
$custom_id = ( isset( $atts['custom_id'] ) ) ?  $atts['custom_id'] : '';
$custom_class = ( isset( $atts['custom_class'] ) ) ? $atts['custom_class'] : '';
?>
<section class="fw-main-row <?php echo esc_attr($section_extra_classes) ?> <?php echo esc_attr($custom_class) ?>" id="<?php echo esc_attr($custom_id) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
